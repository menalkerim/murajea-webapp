...
import { Button } from "@/components/ui/button"; // If you’re using shadcn buttons; else replace with <button>
import { CheckCircle, Users, BookOpen, BarChart3, School } from "lucide-react";

export default function HomePage() {
  return (
    <div className="flex flex-col w-full min-h-screen text-gray-800">
      {/* ===== HERO SECTION ===== */}
      <section className="bg-gradient-to-r from-sky-500 to-blue-600 text-white py-24 px-6 text-center">
      ...
      >
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          <div className="p-6 shadow rounded-xl">
            <Users className="w-10 h-10 mx-auto text-sky-500 mb-4" />
            <h3 className="font-semibold text-xl mb-2">For Admins</h3>
            <p>
              Centralized management of teachers, students, and data—all in one
              dashboard.
            </p>
          </div>
          <div className="p-6 shadow rounded-xl">
            <BookOpen className="w-10 h-10 mx-auto text-sky-500 mb-4" />
          ...
          <div className="p-6 shadow rounded-xl">
            <BarChart3 className="w-10 h-10 mx-auto text-sky-500 mb-4" />
            <h3 className="font-semibold text-xl mb-2">For Students</h3>
            <p>
              Access learning materials, view grades, and monitor your academic
              progress anytime.
            </p>
          </div>
        </div>
      ...
      <section className="bg-gray-50 py-16 px-6 text-center">
        ...
        <div className="flex flex-col md:flex-row justify-center gap-12 max-w-5xl mx-auto">
          <div className="flex-1">
            <CheckCircle className="w-10 h-10 mx-auto text-sky-500 mb-4" />
            <h3 className="text-xl font-semibold mb-2">1. Register</h3>
            <p>
              Sign up as an Admin, Teacher, or Student to access your dashboard.
            </p>
          </div>
          <div className="flex-1">
            <CheckCircle className="w-10 h-10 mx-auto text-sky-500 mb-4" />
            <h3 className="text-xl font-semibold mb-2">2. Engage</h3>
            <p>
              Start managing classes, creating content, and tracking attendance.
            </p>
          </div>
          <div className="flex-1">
            <CheckCircle className="w-10 h-10 mx-auto text-sky-500 mb-4" />
            <h3 className="text-xl font-semibold mb-2">3. Track Progress</h3>
            <p>Monitor performance through analytics, reports, and insights.</p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-sky-50 py-16 px-6 text-center">
        <h2 className="text-3xl font-bold mb-6">For Teachers & Institutions</h2>
      ...
      <section className="py-16 px-6 bg-white text-center">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {[
            ...
            <div
              key={idx}
              className="p-6 shadow rounded-xl bg-gray-50 hover:shadow-lg transition"
            >
